...
writer = SummaryWriter(comment="_portu_augmented_new")
...
with open('vocab_portu_augmented.json', 'w') as vocab_file:
    json.dump(vocab_dict, vocab_file)

print("----------------- Saving vocab to jason complete. -----------------\n\n")

tokenizer = Wav2Vec2CTCTokenizer("./vocab_portu_augmented.json", unk_token="[UNK]", pad_token="[PAD]",
...
train.save_to_disk('/home/or/Desktop/portu/current/train_augmented_nnn')
validation.save_to_disk('/home/or/Desktop/portu/current/validation_n')
print("----------------- saving datasets complete. -----------\n\n")


#  Loading from file
# print("----------------- Loading Datasets... -----------------")
# train = load_from_disk('/home/or/Desktop/portu/current/train_augmented_nnn')
# validation = load_from_disk('/home/or/Desktop/portu/current/validation_n')
# print("----------------- Loading Datasets complete. ----------\n\n")
@dataclass
...
training_args = TrainingArguments(
    output_dir="portu_augmented_new",
    ...
    num_train_epochs=10,
    fp16=True,
    save_steps=898,  # change to num_of_samples / batch size to save on epoch
    eval_steps=100,
    logging_steps=10,
    learning_rate=3e-4,
    warmup_steps=500,
