...
path = '/home/or/Desktop/arabic_new_dataset'
new_path = path + '/augmented_GaussianNoise_audio'  # for every type of augment change name here
os.makedirs(new_path)  # only once creates directory
mp3_pre_augment = glob.glob('/home/or/Desktop/arabic_new_dataset/train/*mp3')  # switch with path to location of mp3 files
...
for mp3 in mp3_pre_augment:
    ...
    fullpath = '/home/or/Desktop/arabic_new_dataset/train/' + filename + '.mp3'
